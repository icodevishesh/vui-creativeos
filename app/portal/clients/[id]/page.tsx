  ...
  if (error || !client) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/portal/clients" className="text-primary hover:underline mt-4 inline-block">
          Back to all clients
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-2 text-sm font-medium text-gray-400">
        <Link href="/portal/clients" className="hover:text-primary transition-colors flex items-center gap-1">
