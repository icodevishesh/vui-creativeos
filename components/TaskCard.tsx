...
export const TaskCard: React.FC<TaskCardProps> = ({ task, onClick }) => {
  ...
  return (
    <button
      ...
      className={`w-full text-left border ${statusConfig.borderColor} ${statusConfig.bgColor} rounded p-2 shadow-sm hover:shadow-md transition-shadow cursor-pointer`}
    >
      {/* Assignee Name */}
